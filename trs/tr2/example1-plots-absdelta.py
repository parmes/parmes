...
for kin in kinem:
  for case in cases:
    ...
    V_X_Y = {}
    ic = cases.index(case)
    with open('example1-data/tr2-dru100-absdelta-iters', 'r') as inp:
      ln = inp.readline()
      ln = ln.split(' = ')
      while ln != ['']:
	name = ln[0].split('_')
...
for kin in kinem:
  for case in cases:
    ...
    V_X_Y = {}
    ic = cases.index(case)
    with open('example1-data/tr2-dru100-absdelta-runtimes', 'r') as inp:
      ln = inp.readline()
      ln = ln.split(' = ')
      while ln != ['']:
	name = ln[0].split('_')
...
for kin in kinem:
  for case in cases:
    ...
    V_X_Y = {}
    ic = cases.index(case)
    with open('example1-data/tr2-dru100-absdelta-timings', 'r') as inp:
      ln = inp.readline()
      ln = ln.split(' = ')
      while ln != ['']:
	name = ln[0].split('_')
