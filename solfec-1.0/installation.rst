...
* (optional) :ref:`Parmec <parmec-index>` source path if you wish to use the :ref:`HYBRID_SOLVER <solfec-1.0-command-HYBRID_SOLVER>`
  and :ref:`hybrid modeling <solfec-1.0-examples-hybrid_modeling>`
