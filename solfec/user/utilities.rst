...
This routine splits a meshed BODY object along a surface aligned with internal element boundaries.
...
.. topic:: (body2, lst1, lst2) = RT_SPLIT (body1, surf | sid1, sid2, label1, label2) :red:`(Under development)`
  ...
  * surf -- surface definition of the split plane on **body1**: a list of lists face nodes *[[n0, n1, n2], [n3, n4, n5, n6], ...]*
...
7. RT_SPLIT terminates with an error message in case none or more then two mesh fragments are created.
...
.. topic:: obj = COROTATED_DISPLACEMENTS (solfec, subset | sampling)  :red:`(Under development)`
...
.. topic:: obj = RIGID_DISPLACEMENTS (body) :red:`(Under development)`
