...
Solfec includes equality constraints, or joints, and contact constraints applied at individual contact points.
...
as covariant and contravariant, respectively. In Solfec we use an
...
time integration is implemented in Solfec.
