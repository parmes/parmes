...
experimenting. If you happened to use an output subdirectory by invoking the ``[-s sub-directory]`` Solfec command line switch, e.g.
...
and in order to generate the reduced bases you will need to keep informing Solfec about this, e.g.
